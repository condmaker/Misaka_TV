...
load_dotenv()
token = os.getenv("NjM1MTI4NjY0MTQ0NjA5Mjgx.XaskUg.WF9BAzs9k8wYfH5FuwqS1odiUcY")
    ...
    if message.content == "Battle Royale Start!":
        ...
        for index in range(len(guild.members)-1):
            ...
            if message.content == "Battle Royale Stop!":
                break
            index = 0
            channel = client.get_channel(413131836827631627) #ID canal
...
client.run("NjM1MTI4NjY0MTQ0NjA5Mjgx.XaskUg.WF9BAzs9k8wYfH5FuwqS1odiUcY")